document.addEventListener('DOMContentLoaded', function() {
    ...
    // Sample data
    const artworks = [
        { id: 1, image: '../public/images/FB_IMG_1.jpg', title: 'The Starry Night', artist: 'Vincent van Gogh', price: '$100,000,000' },
        { id: 2, image: '../public/images/FB_IMG_2.jpg', title: 'Mona Lisa', artist: 'Leonardo da Vinci', price: 'Priceless' }
    ];

    const exhibitions = [
        { id: 1, image: '../public/images/FB_IMG_7.jpg', title: 'Art Through the Ages', description: 'Explore the evolution of art through various ages...' }
    ];
